...
# -*- coding: utf-8 -*-
#  ==========================================================================
#  PhytoScope — attribution — src/sdk/outils/nouveau_module.py
#
#  Version  : 1.5.1
#  Date     : 2026-09-18
...
.. code-block:: console
    ...
    python3 src/sdk/outils/nouveau_module.py mon-module
...
def version_api() -> str:
    ...
    chemin = os.path.join(LOGICIEL, "phytoscope", "api", "contrat.py")
    try:
