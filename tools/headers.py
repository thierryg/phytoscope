...
.. code-block:: console
    ...
    python3 tools/headers.py                 ce qui serait changé
    python3 tools/headers.py --ecrire        appliquer
    python3 tools/headers.py --verifier      échoue s'il en manque (intégration)
"""
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if args.verifier:
        if a_changer:
            ...
            print("\n      python3 tools/headers.py --ecrire\n")
            return 1
    ...
    if not args.ecrire:
        ...
        print("      python3 tools/headers.py --ecrire\n")
        return 0
