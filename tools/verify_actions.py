...
# -*- coding: utf-8 -*-
#  ==========================================================================
#  PhytoScope — attribution — tools/verify_actions.py
#
#  Version   : 1.6.0
#  Date      : 2026-09-23
...
Usage :
    python3 tools/verify_actions.py            contrôle .github/workflows/
    python3 tools/verify_actions.py --epingle   exige en plus une empreinte
