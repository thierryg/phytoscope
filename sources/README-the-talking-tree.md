...
> de style `pdf-src/tree.css` (pour ne pas entrer en conflit avec `build.py` et
...
| **II. Biocommunication végétale et IA** | `plant-biocommunication-and-ai.pdf` | 163 | Que sait-on vraiment de la signalisation végétale ? |
| **III. Créer un arbre parlant** | `workshop-build-a-talking-tree.pdf` | 198 | Comment le refaire soi-même, honnêtement ? |
...
- La mise en forme est centralisée dans `pdf-src/tree.css`.
